...
create_table_query = """
    ...
    """
insert_data_query="""
INSERT INTO films (title,director,year) VALUES ('Docteur Strange','Scott Derrickson','2016')
"""
#Create 
# connection.execute(text('CREATE TABLE IF NOT EXISTS films (title text, director text, year text'))
#connection.execute(text("INSERT INTO films (title, director, year) VALUES ('Doctor Strange', 'Scott Derickson')"))
